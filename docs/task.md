# The task
## Situation
Payment Provider Comapny allows private and business clients to `deposit` and `withdraw` funds to and from Payment Provider Comapny accounts in multiple currencies. Clients may be charged a commission fee.
...
1. Third party frameworks, libraries, dependencies, tools are **not required** but **allowed**.
    ...
    2. Avoid including framework or any dependencies into your task if you don't actually use them;
...
8. Do not use Payment Provider Comapny name in titles, descriptions or the code itself. This helps others to find the libraries that are really related to our services and/or are developed and maintained by our team.

# Evaluation Criteria
1. Requirements considered as met by Payment Provider Comapny development team. It would be best if all requirements are met;
